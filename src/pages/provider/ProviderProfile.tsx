...
import { ArrowLeft, Star, Briefcase, Wallet, LogOut, ChevronRight, UserEdit, SwitchCamera, MapPin, Clock, Image as ImageIcon, FileText, Settings } from "lucide-react";
    ...
    <div className="min-h-full flex flex-col bg-background pb-8">
      ...
      <div className="px-5 flex-1 space-y-4">
        ...
        <div className="bg-card border border-border rounded-2xl shadow-card overflow-hidden">
          <Item icon={UserEdit} label="Edit Profile" onClick={() => toast("Edit Profile coming soon")} />
